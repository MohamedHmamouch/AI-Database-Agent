...
class LoadConfig:
    ...
    def __init__(self):
        ...
        self.load_openai_models(app_config=app_config)
    ...
    def load_directories(self, app_config):
        ...
        # Ensure persist_directory is converted to a string for compatibility with chromadb
    ...
    def load_openai_models(self, app_config):
        self.openai_key = os.environ['OPENAI_API_KEY']
        self.embedding_model_name = app_config['embedding']['model_name']
    ...
    def load_chroma_client(self):
        # Convert persist_directory to string (fix for the TypeError)
